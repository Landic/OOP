...
void UserComputerClub::Borrow_Weak_Computer(AdminComputerClub& obj)
{
	short hour = 0;
	...
	// проверка если есть один элемент и пк свободен то срабатывает блок кода ниже
		...
		if (hour < 1) { // меньше одного часа нельзя взять
			...
			cout << " ----------------" << endl;
			cout << "|This is cost " << 50 * hour << "$|" << endl;
			cout << " ----------------" << endl;
			Sleep(1000);
			system("cls");
...
void UserComputerClub::Borrow_Average_Computer(AdminComputerClub& obj)
{
	short hour = 0;
	...
	// проверка если есть один элемент и пк свободен то срабатывает блок кода ниже
		...
		if (hour < 1) { // меньше одного часа нельзя взять
			...
			cout << " -----------------" << endl;
			cout << "|This is cost " << 150 * hour << "$|" << endl;
			cout << " -----------------" << endl;
			Sleep(1000);
			system("cls");
...
void UserComputerClub::Borrow_Powerful_Computer(AdminComputerClub& obj)
{
	short hour = 0;
	...
	// проверка если есть один элемент и пк свободен то срабатывает блок кода ниже
		...
		if (hour < 1) { // меньше одного часа нельзя взять
			...
			cout << " -----------------" << endl;
			cout << "|This is cost " << 250 * hour << "$|" << endl;
			cout << " -----------------" << endl;
			Sleep(1000);
			system("cls");
...
void UserComputerClub::Release_The_Weak_Computer(AdminComputerClub& obj) {
...
void UserComputerClub::Release_The_Average_Computer(AdminComputerClub& obj) {
...
void UserComputerClub::Release_The_Powerful_Computer(AdminComputerClub& obj) {
